...
class HabitTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.data_with_reward_and_enjoyable_habit = {
            ...
            'action': 'спать',
            'reward': 'поспать',
            'pleasant_habit': self.another_habit.pk,
        }
    ...
    def test_get_list(self):
        ...
        self.assertEqual(
            response['results'][1]['action'],
            self.second_habit.action,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            response['results'][1]['is_pleasant_habit'],
            self.second_habit.is_pleasant_habit,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            response['results'][1]['pleasant_habit'],
            self.second_habit.pleasant_habit,
        )
        self.assertEqual(
    ...
    def test_get_detail(self):
        ...
        self.assertEqual(
            response['is_pleasant_habit'],
            self.habit.is_pleasant_habit,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            response['pleasant_habit'],
            self.habit.pleasant_habit,
        )
        self.assertEqual(
            response['user'],
            self.user.pk,
    ...
    def test_post_create(self):
        ...
        self.assertEqual(
            response['action'], self.data['action'],
        )
        self.assertEqual(
            response['reward'], None,
        )
        self.assertEqual(
            response['is_pleasant_habit'], False,
        )
        self.assertEqual(
            response['is_published'], False,
        )
        self.assertEqual(
            response['pleasant_habit'], None,
        )
